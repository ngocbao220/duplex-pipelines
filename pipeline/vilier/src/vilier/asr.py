"""Purpose: Transcribe Vilier speaker audio when ASR is enabled.

Inputs: Speaker segments, audio slices and ASR configuration.
Outputs: Transcript records and speaker-audio artifacts.
"""
import argparse
import json
