"""Purpose: Assign speaker labels to Vilier speech intervals.

Inputs: Audio, VAD intervals, diarization configuration and device.
Outputs: Speaker-labelled timeline segments and debug metadata.
"""
import datetime
import json
import logging
...
from .preprocess import slice_waveform, write_wav
