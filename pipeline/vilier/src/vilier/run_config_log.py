"""Purpose: Render the effective Vilier runtime configuration.

Inputs: Config file, CLI model overrides and device availability.
Outputs: Validated configuration log and command exit status.
"""
import argparse
import json
import warnings
