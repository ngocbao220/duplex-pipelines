"""Purpose: Label Vilier transcripts with conversational state.

Inputs: Transcript records and labeling backend configuration.
Outputs: State labels and persisted labeling artifacts.
"""
import json
import os
import re
