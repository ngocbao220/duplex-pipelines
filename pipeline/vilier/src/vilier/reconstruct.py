"""Purpose: Reconstruct and export Vilier speaker timelines.

Inputs: Diarized segments, waveform and output configuration.
Outputs: Speaker tracks, manifests, labels and audio artifacts.
"""
import json
