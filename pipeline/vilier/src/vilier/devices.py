"""Purpose: Resolve Vilier device settings without MPS fallback.

Inputs: Requested device and Torch capability.
Outputs: CPU or CUDA device selection and warnings.
"""
import warnings
