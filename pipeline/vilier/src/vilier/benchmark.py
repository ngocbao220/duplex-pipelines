"""Purpose: Calculate Vilier-native benchmark and report artifacts.

Inputs: Speaker tracks, optional references and benchmark settings.
Outputs: Native-proxy or reference benchmark JSON and tables.
"""
