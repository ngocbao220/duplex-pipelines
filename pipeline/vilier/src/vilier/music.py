"""Purpose: Apply optional music separation for Vilier audio.

Inputs: Waveform, music-separation configuration and device.
Outputs: Speech-focused waveform and music artifacts.
"""
