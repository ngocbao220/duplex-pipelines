"""Purpose: Load, normalize and slice Vilier audio inputs.

Inputs: Audio paths, waveform arrays and requested sample rates.
Outputs: Mono waveforms, persisted WAVs and audio slices.
"""
import math
import subprocess
