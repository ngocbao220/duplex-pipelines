"""Purpose: Separate Vilier overlap regions into speaker audio.

Inputs: Speaker segments, overlap settings, waveform and model configuration.
Outputs: Updated speaker tracks and overlap separation artifacts.
"""
