"""Purpose: Define Vilier model option parsing and overrides.

Inputs: CLI arguments and nested runtime configuration.
Outputs: Validated model/backend override settings.
"""
import argparse
import copy
