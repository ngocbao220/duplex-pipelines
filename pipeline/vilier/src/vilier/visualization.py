"""Purpose: Render optional Vilier waveform and timeline visualizations.

Inputs: Audio waveform, speaker tracks and visualization options.
Outputs: Image artifacts written to the run directory.
"""
...
from .preprocess import slice_waveform
