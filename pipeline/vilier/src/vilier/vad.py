"""Purpose: Detect voice activity for the Vilier pipeline.

Inputs: Normalized waveform, VAD configuration and sample rate.
Outputs: Speech intervals and optional phase artifacts.
"""
