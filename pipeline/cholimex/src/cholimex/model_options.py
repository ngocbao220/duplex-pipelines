"""Purpose: Map Cholimex model aliases to concrete identifiers.

Inputs: Backend names and optional model aliases.
Outputs: Resolved model identifiers and backend choices.
"""
