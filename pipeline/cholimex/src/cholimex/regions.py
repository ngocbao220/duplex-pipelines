"""Purpose: Classify single-speaker and overlap regions from VAD masks.

Inputs: Per-proposal-track activity segments and audio duration.
Outputs: Ordered Cholimex region records.
"""
